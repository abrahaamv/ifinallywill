/**
 * Coming Soon Modal for Meeting App
 * Shows when users click sign in or other protected buttons during beta
 */

import { Button } from '@platform/ui';
import { Mail, Video, X } from 'lucide-react';
...
export function ComingSoonModal({ isOpen, onClose }: ComingSoonModalProps) {
  ...
  const handleRequestAccess = () => {
    onClose();
    window.location.href = `${appUrls.landing}/contact`;
  };
      ...
      <div className="relative w-full max-w-md rounded-3xl bg-[#0c0c0e] border border-white/10 p-8 shadow-2xl">
        ...
        <div className="text-center">
          ...
          <p className="text-white/50 mb-6 leading-relaxed">
            VisualKit Meet is currently in private beta with select partners.
