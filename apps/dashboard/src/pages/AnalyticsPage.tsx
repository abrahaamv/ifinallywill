...
import { Activity, ArrowDown, ArrowUp, BarChart3, Clock, DollarSign, MessageCircle, TrendingUp, Users, Zap } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 rounded-lg border border-green-200 bg-green-50 dark:bg-green-950 dark:border-green-800">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-semibold text-green-900 dark:text-green-100">High Performance</h4>
              </div>
              <p className="text-sm text-green-800 dark:text-green-200">
                API Integration topic showing 85% resolution rate. Consider creating more documentation.
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg border border-blue-200 bg-blue-50 dark:bg-blue-950 dark:border-blue-800">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200">
                Fridays show 15% higher volume. Consider adjusting agent availability during these times.
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg border border-orange-200 bg-orange-50 dark:bg-orange-950 dark:border-orange-800">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-semibold text-orange-900 dark:text-orange-100">Cost Optimization</h4>
              </div>
              <p className="text-sm text-orange-800 dark:text-orange-200">
                82% of conversations resolved with Tier 1 AI (lowest cost). Excellent cost efficiency.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="border-dashed">
        <CardContent className="pt-6">
          ...
          <div className="space-y-1 text-xs text-muted-foreground">
            <p>* Mock data - Real analytics will be populated from actual conversation sessions and knowledge base interactions</p>
            <p>** Topic analysis - Will use AI-powered NLP to automatically categorize and track conversation themes</p>
            <p>*** AI insights - Generated by analyzing patterns in conversation success rates, resolution times, and user feedback</p>
          </div>
        </CardContent>
      </Card>
    </div>
