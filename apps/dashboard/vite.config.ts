  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        // NOTE: Chatwoot is NOT proxied through dashboard in production.
        // It runs on its own subdomain (support.visualkit.live) to avoid API conflicts.
        // For development, Chatwoot is accessed directly at localhost:3000.
      },
    },
    resolve: {
      alias: {
