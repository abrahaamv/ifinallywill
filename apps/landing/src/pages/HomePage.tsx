...
import { Button, Card, CardHeader, CardTitle, CardDescription, Badge } from '@platform/ui';
      ...
      <section className="container mx-auto px-4 py-24 md:py-32">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mb-8 max-w-2xl text-lg text-muted-foreground md:text-xl">
            Real-time voice, vision, and text AI interactions with cost-optimized routing.
            75-85% cost reduction without compromising quality.
          </p>
