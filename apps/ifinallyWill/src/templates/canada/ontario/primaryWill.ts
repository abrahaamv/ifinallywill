...
{{/each}}
 ...
 {{else}}
 If {{#prevGroup}}{{#each this}}{{#findPersonInfo this.guardian ../relatives ../kids ../spouseInfo}}{{fullName}}{{formatLocation city province country}}{{/findPersonInfo}}{{#unless @last}} and {{/unless}}{{/each}}{{/prevGroup}} cannot act or continue to act as Guardians, I appoint
 {{/if_eq}}
 {{#each this}}
 {{#if @index}} and {{/if}}
