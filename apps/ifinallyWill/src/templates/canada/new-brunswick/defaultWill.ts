...
[
 ...
 fallback: "",
 content: `
 <p><br /><br />I, {{personal.fullName}}, presently of {{personal.city}}{{#if personal.province}}, {{personal.province}}{{/if}} declare that this is my Last Will and Testament. I am of the age of majority and of sound mind and understand the nature and extent of my estate. This Will is made in accordance with the Wills Act, R.S.N.B. 1973, c. W-9, and other applicable statutes governing estates and trusts in the Province of New Brunswick.<br /><br /></p>`,
 ...
 fallback: "",
 content: `<ol>
 <li>My Executor shall have full authority, consistent with the Wills Act, R.S.N.B. 1973, c. W-9, and other New Brunswick estate law, to:</li>
 <ul>
 <li>
 ...
 and as free as possible from any court supervision, under the laws of the Province of New Brunswick;
 </li>
 <li>
...
{{/if}}`,
 ...
 title: `<p style="text-align: center"><strong>V. REGISTERED PLANS (RESP / RDSP)</strong></p>`,
 order: 9,
 fallback: "",
 content: `<ol>
 <li>If my Spouse survives me, they shall be appointed Successor Subscriber for any Registered Education Savings Plan (RESP) or Registered Disability Savings Plan (RDSP) for which I am the sole subscriber.</li>
 <li>If my Spouse does not survive me, my Executor shall appoint a suitable person, including a parent, guardian, or other responsible adult, as Successor Subscriber at their discretion.</li>
 <li>The appointment of a Successor Subscriber fully releases my Executor from any further obligations regarding the RESP or RDSP.</li>
</ol>`,
 keywords: [],
 children: []
 },
 ...
 title: `<p style="text-align: center"><strong>{{#if hasKids}}{{#if_gt guardians.length 0}}VI{{else}}VI{{/if_gt}}{{else}}VI{{/if}} TESTAMENTARY TRUSTS</strong></p>`,
 order: 10,
 fallback: "",
...
<ol>
 ...
 <li>To pay himself or herself compensation as set out in the Trustee Act, R.S.N.B. 1973, c. T-15, out of the
 trust assets; and</li>
...
<ol>
 ...
 title: `<p style="text-align: center"><strong>{{#if hasKids}}{{#if_gt guardians.length 0}}VII{{else}}VII{{/if_gt}}{{else}}VII{{/if}}. DIGITAL ASSETS</strong></p>`,
 order: 12,
 fallback: "",
 content: `<ol>
 ...
 {
 id: "defaultWill-pets",
 title: `<p style="text-align: center"><strong>VIII. PETS</strong></p>`,
 order: 13,
 fallback: "",
 content: `{{#if pets}}
 {{#if_gt pets.length 0}}
 <ol>
 {{#each pets}}
 <li>I appoint {{this.guardian}} as caretaker of any pets I leave behind.</li>
 {{#if this.backup}}
 {{#if_neq this.backup "N/A"}}
 <li>If the caretaker cannot or refuses, my Executor may place the pet in a safe, loving environment.</li>
 {{/if_neq}}
 {{/if}}
 {{/each}}
 </ol>
...
{{/if}}`,
 ...
 title: `<p style="text-align: center"><strong>{{#if hasKids}}{{#if_gt guardians.length 0}}IX{{else}}IX{{/if_gt}}{{else}}IX{{/if}}. GENERAL PROVISIONS</strong></p>`,
 order: 14,
 fallback: "",
...
<ol>
 ...
 purposes of Part I of the Marital Property Act, S.N.B. 2012, c. 107, as amended (the &ldquo;Marital Property Act&rdquo;) and
 ...
 Marital Property Act. This declaration shall be an express statement within the meaning of section 112 of the
 Marital Property Act and shall have effect to the extent permitted by that statute, any successor legislation thereto
...
<ol>
 ...
 witnesses, who witnessed and subscribed this Last Will at my request, and in my presence, all being present at the same time.
...
and Testament, in our presence, who at the Testator&rsquo;s request and in the presence of the Testator, all being
present at the same time in {{personal.city}}, {{personal.province}}, have signed our names as witnesses in the Testator&rsquo;s presence on the above date. <br /><br /><br />
...
Witness #2 ____________________________________<br /><br /> Address:<br />________________________________________________<br />________________________________________________</p> <br /><p style="text-align: center"><strong>LAST WILL AND TESTAMENT OF {{personal.fullName}}</strong></p><p><br /><br /><br /><br /><br /> <br /><br /><br /><br /><br /><br /> Prepared by: iFinallyWill<br /> {{personal.city}}, {{personal.province}}<br />
<br /><br /><br /><br />
</p>`,
