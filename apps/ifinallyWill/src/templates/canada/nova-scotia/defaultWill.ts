...
[
 ...
 and as free as possible from any court supervision, under the laws of the Province of Nova Scotia;
 </li>
 <li>
...
{{/each}}
 ...
 fallback: "",
 content: `<ol>
 <li>If at the time of my death I hold any interest in or am entitled to any interest in a Registered Education Savings Plan ("RESP") or a Registered Disability Savings Plan ("RDSP"), I direct my Executor(s) to deal with such plans in the following manner:</li>
 <ul>
 <li>Any RESP of which I am the subscriber shall be transferred to my spouse, if living, and if not living, then to my children equally. If no spouse or children survive me, then I direct my Executor(s) to collapse such plans and add the proceeds to my estate residue;</li>
 <li>Any RDSP of which I am the holder shall be transferred to my spouse, if living, and such spouse is a qualified person under the Income Tax Act to be a holder of the plan. If my spouse does not survive me or is not a qualified person, then I direct my Executor(s) to transfer the plan to any qualified family member who consents to become the holder. If no qualified family member consents, then I direct my Executor(s) to collapse such plans and add the proceeds to my estate residue;</li>
 <li>My Executor(s) shall have the authority to make any elections, designations, or other decisions necessary to implement these directions, including any elections under the Income Tax Act.</li>
 </ul>
</ol>`,
 keywords: [],
 children: []
 ...
 title: `{{#if hasKids}}{{#if_gt guardians.length 0}}<p style="text-align: center"><strong>V. CHILDREN</strong></p>{{/if_gt}}{{/if}}`,
 order: 9,
 fallback: "",
 content: `{{#if hasKids}}
...
<ol>
 ...
 <li>To pay himself or herself compensation as set out in the Trustee Act, R.S.N.S. 1989, c. 479, out of the
 trust assets; and</li>
...
<ol>
 ...
 {{#if_gt this.amount 0}}
 <ul>
 I direct my Executor to provide a maximum of $ {{ this.amount }} (CAD)
...
<ol>
 ...
 purposes of Part I of the Matrimonial Property Act, R.S.N.S. 1989, c. 275, as amended (the &ldquo;Family Law Act&rdquo;) and
