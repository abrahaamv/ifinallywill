...
[
 ...
 title: `<h2 class='document-header'>Power of Attorney for Personal Care of {{personal.fullName}}</h2><br />`,
 order: 1,
 fallback: "",
 content: `<p><strong>POWER OF ATTORNEY FOR PERSONAL CARE OF {{personal.fullName}}</strong></p>`,
 ...
 fallback: "",
 content: `<p>
 I, {{personal.fullName}} of {{personal.city}}{{#if personal.province}}, {{personal.province}}{{/if}}, being of sound mind and of legal age to execute this document, do hereby make this Power of Attorney for Personal Care. I fully understand the consequences of my actions in doing so. I intend this Power of Attorney for Personal Care to be read by my health care providers, family, and friends as a true reflection of my wishes and instructions should I lack capacity and be unable to communicate such wishes and instructions.
 </p>`,
 ...
 <ul>
 <li>"Act" means the Prince Edward Island Consent to Treatment and Health Care Directives Act.</li>
 ...
 title: `<p><strong>Revoke Previous Power of Attorney for Personal Care</strong></p>`,
 order: 4,
 fallback: "",
 content: `<ol start="2">
 ...
 be the Grantor's Power of Attorney for Personal Care, who at the Grantor's
...
<br /><br /><br /><br />
 ...
 order: 19,
 fallback: "",
 content: `<p>(Each Attorney should sign or acknowledge the Power of Attorney for Personal Care)</p>
