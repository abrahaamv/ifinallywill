...
[
 ...
 title: `<h2 class='document-header'>Representation Agreement of {{personal.fullName}}</h2><br />`,
 order: 1,
 fallback: "",
 content: `<p><strong>REPRESENTATION AGREEMENT OF {{personal.fullName}}</strong></p>`,
 ...
 fallback: "",
 content: `<p>
 I, {{personal.fullName}} of {{personal.city}}{{#if personal.province}}, {{personal.province}}{{/if}}, being of sound mind and of legal age to execute this document, do hereby make this Representation Agreement. I fully understand the consequences of my actions in doing so. I intend this Representation Agreement to be read by my health care providers, family, and friends as a true reflection of my wishes and instructions should I lack capacity and be unable to communicate such wishes and instructions.
 </p>`,
 ...
 <ul>
 <li>"Act" means the Representation Agreement Act, RSBC 1996, c 405.</li>
 ...
 title: `<p><strong>Revoke Previous Representation Agreement</strong></p>`,
 order: 4,
 fallback: "",
 content: `<ol start="2">
 <li>I revoke any previous Representation Agreement made by me.</li>
 </ol>`,
 keywords: [],
 children: []
 },
 ...
 keywords: ["attorneyOne.relation", "attorneyOne.fullName", "attorneyOne.city", "attorneyOne.province", "attorneyOne.country", "attorneyTwo"],
 children: []
 },
 {
 id: "poaHealth-duties",
 ...
 <li>
 Notwithstanding any instructions contained in this Representation Agreement, my Attorney
 ...
 content: `<ol start="6">
 <li>
 The authority granted to my Attorney under this Representation Agreement will be in effect
 ...
 declaration to me and to the Attorney I have designated in this Representation Agreement.
 </li>
 </ol>`,
 keywords: [],
 children: []
 ...
 keywords: ["statements.terminalCondition.noLifeSupport", "statements.terminalCondition.noTubeFeeding", "statements.terminalCondition.noActiveTreatment",
 "statements.unconsciousCondition.noLifeSupport", "statements.unconsciousCondition.noTubeFeeding", "statements.unconsciousCondition.noActiveTreatment",
 "statements.mentalImpairment.noLifeSupport", "statements.mentalImpairment.noTubeFeeding", "statements.mentalImpairment.noActiveTreatment",
 "statements.violentBehavior.useDrugs", "statements.painManagement.useDrugs"],
 children: []
 },
 {
 ...
 content: `<ol start="10">
 <li>
 The authority granted in this Representation Agreement may be revoked as and where
 permitted by law.
 </li>
 <li>
 I understand that, as long as I have Capacity, I may revoke this Representation Agreement at
 any time.
 </li>
 </ol>`,
 keywords: [],
 ...
 Representation Agreement and by the Act.
 </li>
 <li>
 ...
 fallback: "",
 content: `<ol start="20">
 <li>A copy of this Representation Agreement has the same effect as the original.</li>
 <li>
 If any part or parts of this Representation Agreement is found to be invalid or illegal under
 ...
 illegal part or parts had never been included in this Representation Agreement. But if the
 intent of this Representation Agreement would be substantially changed by such construction,
 then it shall not be so construed.
 </li>
 <li>This Representation Agreement is intended to be governed by the laws of the Province of
 British Columbia.</li>
 </ol>`,
 keywords: [],
 children: []
 ...
 be the Grantor's Representation Agreement, who at the Grantor's
 request and in the presence of the Grantor, physical presence of each
...
<br /><br /><br /><br />
 ...
 order: 19,
 fallback: "",
 content: `<p>(Each Attorney should sign or acknowledge the Representation Agreement)</p>
