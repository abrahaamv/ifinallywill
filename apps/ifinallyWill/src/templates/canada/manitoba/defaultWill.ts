...
[
 ...
 and as free as possible from any court supervision, under the laws of the Province of Manitoba;
 </li>
 <li>
...
{{/if}}`,
 ...
 title: `<p style="text-align: center"><strong>{{#if hasKids}}{{#if_gt guardians.length 0}}V{{else}}IV{{/if_gt}}{{else}}IV{{/if}} TESTAMENTARY TRUSTS</strong></p>`,
 order: 9,
 fallback: "",
...
<ol>
 ...
 <li>To pay himself or herself compensation as set out in the Trustee Act, C.C.S.M. c. T160, out of the
 trust assets; and</li>
...
<ol>
 ...
 title: `<p style="text-align: center"><strong>{{#if hasKids}}{{#if_gt guardians.length 0}}VI{{else}}V{{/if_gt}}{{else}}V{{/if}}. DIGITAL ASSETS</strong></p>`,
 order: 10,
 fallback: "",
 content: `<ol>
 ...
 title: `<p style="text-align: center"><strong>{{#if hasKids}}{{#if_gt guardians.length 0}}VII{{else}}VI{{/if_gt}}{{else}}VI{{/if}}. GENERAL PROVISIONS</strong></p>`,
 order: 11,
 fallback: "",
 content: `{{#if pets}}
 {{#if_gt pets.length 0}}
...
<ol>
 ...
 purposes of the Family Property Act, C.C.S.M. c. F25, as amended (the &ldquo;Family Property Act&rdquo;) and
 ...
 Family Property Act. This declaration shall be an express statement within the meaning of section 14 of the
 Family Property Act and shall have effect to the extent permitted by that statute, any successor legislation thereto
