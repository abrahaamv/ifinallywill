/**
 * POA for Health step — designate someone for medical decisions
 */

import type { StepProps } from '../../lib/types';

export function PoaHealthStep({ onNext, onPrev, isFirstStep, isLastStep }: StepProps) {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-[var(--ifw-neutral-900)]">POA for Health</h2>
        <p className="mt-1 text-sm text-[var(--ifw-neutral-500)]">
          Designate someone to make medical decisions on your behalf. Share your healthcare wishes
      ...
      <div className="rounded-xl border border-[var(--ifw-neutral-200)] bg-white p-6">
        <div className="text-center py-8">
          ...
          <p className="text-sm text-[var(--ifw-neutral-500)] max-w-md mx-auto">
            This document allows your chosen attorney to make health care decisions for you,
            including treatment options, care facilities, and end-of-life decisions.
          </p>
