  ...
  return (
    ...
    >
      <div className="space-y-5">
        {/* Full Legal Name */}
        <div>
          <label htmlFor="pi-fullName" className="block text-sm font-medium mb-1">
            Full Legal Name *
          </label>
          <input
            id="pi-fullName"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label htmlFor="pi-email" className="block text-sm font-medium mb-1">
              Email *
            </label>
            <input
              id="pi-email"
          ...
          <div>
            <label htmlFor="pi-phone" className="block text-sm font-medium mb-1">
              Phone
            </label>
            <input
              id="pi-phone"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label htmlFor="pi-gender" className="block text-sm font-medium mb-1">
              Gender
            </label>
          ...
          <div>
            <label htmlFor="pi-dob" className="block text-sm font-medium mb-1">
              Date of Birth
            </label>
            <input id="pi-dob" type="date" {...register('dateOfBirth')} className="ifw-input" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="relative">
            <label htmlFor="pi-city" className="block text-sm font-medium mb-1">
              City *
            </label>
            <input
              id="pi-city"
          ...
          <div>
            <label htmlFor="pi-province" className="block text-sm font-medium mb-1">
              Province *
            </label>
        ...
        <div>
          <label htmlFor="pi-country" className="block text-sm font-medium mb-1">
            Country
          </label>
          <input
            id="pi-country"
        ...
        <div className="ifw-info-box">
          <strong>Why do we need this?</strong> Your legal name, location, and date of birth are
          required to create a valid will in Canada. Provincial laws determine specific requirements
          for your will, so your city and province help us generate the correct legal document for
          your jurisdiction.
        </div>
      </div>
    </StepLayout>
